# Streamdata.io API Gallery - OWASP API Security Project Profiling
This is a repository for managing the profiling of OWASP API Security Project. Right now, it is just a Github repository, README, and an [APIs.json](apis.md) outlining some of the details of OWASP API Security Project, including different links and artificats defining their operation.
...
Once there is an OpenAPI for OWASP API Security Project, it will be available within the [Streamdata.io API Gallery](http://api.gallery.streamdata.io/), until then the companies profile will be used in a variety of other sites and applications.
